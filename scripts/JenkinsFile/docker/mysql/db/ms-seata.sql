/*
 ...
 Source Schema         : ms-seata

 Target Server Type    : MySQL
 Target Server Version : 80033 (8.0.33-0ubuntu0.22.04.2)
 File Encoding         : 65001

 Date: 25/06/2023 21:45:41
*/
DROP DATABASE IF EXISTS `ms-seata`;

CREATE DATABASE  `ms-seata` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
